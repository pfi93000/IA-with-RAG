"""Module de test de MLflow (écriture puis lecture)."""
...
while check_url:
    try:
        r = requests.get(mlflow_url, timeout=10)
        check_url=False
...
print(r)
# on remonte dans MLflow 2 paramètres (qui devraient être utilisés
#  pour personnaliser notre apprentissage)
